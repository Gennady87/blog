> [!attention] Данная инструкция служит исключительно для настройки доступа к легальным сервисам, самостоятельно ограничившим доступ для пользователей из России по собственной политике. Она не предназначена для обхода блокировок запрещённых в РФ ресурсов, установленных российским законодательством.
